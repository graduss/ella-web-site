        ...
        <div className="container">
          ...
          <div className="py-8">
            <p className="text-center text-base text-white">
              &copy; ConstMax 2024. &nbsp;<em className="text-gray-400 text-nowrap">Разработан <Link href={"https://www.linkedin.com/in/azhyburtovich/"}>Aliaksandr Zhyburtovich</Link> &nbsp;v{version}</em>
            </p>
          </div>
        </div>
      </footer>
